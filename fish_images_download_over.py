...
class fish_images_download:
    ...
    def download_image(self,image_url,image_format,main_directory,dir_name,count):
        try:
            ...
            try:
                ...
                image_name = dir_name + "_" + str(count).zfill(4) + '.jpg'
    ...
    def download(self,keyword, limit):
        ...
        main_directory = "fish_images_google"
        ...
        try:
        	...
        	print("Error with chromedriver. Check chrimedriver installation and path.")
        	sys.exit()
        ...
        try:
        	brower.find_element_by_id("smb").click()
        	for i in range(100):
        		element.send_keys(Keys.PAGE_DOWN)
        		time.sleep(0.3)
        except:
        ...
        #print("Path: " + abs_path[0])

        return abs_path

def main():
    fish = urllib.parse.quote_plus(str(input("Enter Name: ")))
    limit = int(input("Enter Amout: "))

    response = fish_images_download()
    paths = response.download(fish, limit)
